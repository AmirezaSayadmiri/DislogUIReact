                        ...
                        <ul>
                            <li
                                ...
                                className={`text-center flex justify-center gap-1 py-4 border border-2 transition-all hover:bg-blue-950 hover:text-white ${
                                    location.pathname === "/dashboard" ? "bg-blue-950 text-white" : ""
                                }`}
                            >
                                <AccountCircle />
                            ...
                            <li
                                ...
                                className={`text-center flex justify-center gap-1 py-4 border border-2 transition-all hover:bg-blue-950 hover:text-white ${
                                    location.pathname === "/dashboard/edit" ? "bg-blue-950 text-white" : ""
                                }`}
                            >
                                <Settings />
                            ...
                            <li
                                ...
                                className={`text-center flex justify-center gap-1 py-4 border border-2 transition-all hover:bg-blue-950 hover:text-white ${
                                    location.pathname === "/dashboard/tickets" ? "bg-blue-950 text-white" : ""
                                }`}
                            >
