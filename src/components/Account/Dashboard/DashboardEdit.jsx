...
const DashboardEdit = () => {
  ...
  return (
    <div className="flex flex-col mt-10 lg:mt-0 p-10">
      ...
      <div className="flex mt-[100px] flex-col justify-center items-center gap-4">
        <textarea
          ...
          {newProfile.skills.map((skill) => (
            ...
            >
              ...
              <button
                ...
                onClick={() => {
                  const skills = newProfile.skills.filter(
                    (skilll) => skilll !== skill
                  );
                  setNewProfile((prev) => {
        ...
        <button
          ...
          className="bg-blue-900 text-white w-[200px] rounded-sm p-2"
        >
          ذخیره تغییرات
        </button>
      </div>
